...
import com.example.uniapp.front.presenter.comparator.TrainingDateComparator;
...
public class TrainingPresenter extends Controller {
    ...
    public TrainingPresenter(TrainingsFragment view) {
        super(view);
        this.view    = view;
    }
    ...
    private void updatePoolSizeSpinner() {
        view.getDropdownPool().setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                updateCurrentTrainings();
                TrainingPresenter.this.view.setupTrainingList();
            }
        });
    }
