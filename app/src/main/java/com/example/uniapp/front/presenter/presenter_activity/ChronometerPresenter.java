package com.example.uniapp.front.presenter.presenter_activity;
...
public class ChronometerPresenter extends Controller {
    ...
    public ChronometerPresenter(ChronometerActivity view) {
        super(view);
        this.view = view;
    }
