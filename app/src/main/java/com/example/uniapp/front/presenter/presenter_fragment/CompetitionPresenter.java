...
import com.example.uniapp.front.presenter.listener.SwimCardListener;
...
public class CompetitionPresenter extends Controller {
    ...
    public CompetitionPresenter(CompetitionsFragment view) {
        super(view);
        this.view         = view;
        ...
        view.getSelectSwimDistance().setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (newDistance != distance) {
                    ...
                    updateCurrentRaces();
                    CompetitionPresenter.this.view.setupRaceList();
                    CompetitionPresenter.this.view.setupLineChart(false);
                }
            }
        });
    }
